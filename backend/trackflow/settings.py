...
if DB_ENGINE == 'postgres':
    DATABASES = {
        'default': {
            ...
            'NAME': config('DB_NAME', default='trackflow_db'),
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='TrackFlow <no-reply@trackflow.local>')

FRONTEND_URL = config('FRONTEND_URL', default='http://localhost:5173')

# Microsoft / Outlook integration (Epic 8). Empty by default; the integration
# endpoints return 503 until these are set in backend/.env.
MS_CLIENT_ID = config('MS_CLIENT_ID', default='')
MS_CLIENT_SECRET = config('MS_CLIENT_SECRET', default='')
MS_TENANT = config('MS_TENANT', default='common')
MS_REDIRECT_URI = config(
    'MS_REDIRECT_URI',
